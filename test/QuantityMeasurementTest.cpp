...
TEST(Add_Two_Unit_Test, given_2_inch_and_2_5_cm_should_equal_3_inches)
{
    QuantityMeasurement quantity_measurement;
    double value_1 = quantity_measurement.getConvertedValue(Unit::INCH, 2.0);
    double value_2 = quantity_measurement.getConvertedValue(Unit::CENTIMETER, 2.5);
    double result = quantity_measurement.addTwoUnits(value_1, value_2);
    double expected = 3;
    ASSERT_EQ(expected, result);
}
...
TEST(Volume_Test, given_1_gallon_and_3_78_litres__when_added_should_return_7_57_L)
{
    QuantityMeasurement quantity_measurement;
    double value_1 = quantity_measurement.getConvertedValue(Unit::GALLON, 1.0);
    double value_2 = quantity_measurement.getConvertedValue(Unit::LITRE, 3.78);
    double result = quantity_measurement.addTwoUnits(value_1, value_2);
...
{
    QuantityMeasurement quantity_measurement;
    double result_1 = quantity_measurement.getConvertedValue(Unit::KILOGRAM, 1.0);
    double result_2 = quantity_measurement.getConvertedValue(Unit::GRAM, 1000);
    ASSERT_EQ(result_1, result_2);
}

TEST(Weight_Test, given_1_tonne_and_1000_kg__should_be_equal)
{
    QuantityMeasurement quantity_measurement;
...
TEST(Temprature_Test, given_212_Fahrenheit_and_100_Celsius__should_be_equal)
{
    QuantityMeasurement quantity_measurement;
    double result_1 = quantity_measurement.temperatureConversion(UnitType::FAHRENHEIT, 212);
    double result_2 = quantity_measurement.temperatureConversion(UnitType::CELSIUS, 100);
    ASSERT_EQ(result_1, result_2);
}
